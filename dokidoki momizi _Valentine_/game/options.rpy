...
define config.name = _("dokidoki momizi _Valentine_")
...
define build.name = "dokidokimomizi_Valentine_"
...
define config.save_directory = "dokidokimomizi_Valentine_-1768724593"
